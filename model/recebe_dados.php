	...
	//Tratando erros caso não seja digitados valores nos campos...					
     if($_POST["login_usuario"] == "" || $query == FALSE) {
                  ...
                  echo"<script>alert('O campo de senha não foi digitado.');</script>";
                   ...
                   echo"<script>alert('Você não marcou a opção que está de acordo com os termos de condições de uso do sistema.');</script>";
                   $rsp == FALSE;
				   //header("Location:../index.php");
				    echo"<META HTTP-EQUIV=REFRESH CONTENT=1;url=../index.php>";
            ...
            if($query == TRUE) {
                    echo"<script>alert('Cadastrado realizado com sucesso,se for seu desejo já pode acessar o sistema.');</script>";
					//header("Location:../index.php");
					 echo"<META HTTP-EQUIV=REFRESH CONTENT=1;url=../index.php>";
