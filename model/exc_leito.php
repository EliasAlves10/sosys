...
require"../controller/connect_bd.php";
            ...
            $del= mysql_query("DELETE FROM leito WHERE id = $id");

            if($del == FALSE) {
                        echo"<script>alert('Nenhum registro foi deletado,Leito não existe ou houve erro ao deletar,tente novamente.');</script>";
