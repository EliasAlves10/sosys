     ...
     while($mostra_dados = mysql_fetch_array($pega_dados)){
		 ...
		 $rg_paciente = $mostra_dados['rg_paciente'];
				...
				echo"<tr class='warning'>";
						...
						echo"<th><center><a href='editer_paciente.php?id=$id'><input class='btn btn-primary' type='button' value='Dados Paciente'></a></center></th>";
						echo"<th><center><a href='editer_respaciente.php?id=$id'><input class='btn btn-primary' type='button' value='Dados Responsavel'></a></center></th>";
						echo"<th><center><a href='editer_dados_internacao.php?id=$id'><input class='btn btn-primary' type='button' value='Dados Internação'></a></center></th>";
				echo"</tr>";
