											...
											<div class="accordion-group">
												...
												<div id="collapse2" class="accordion-body collapse">
												  <div class="accordion-inner">
													...
													<a class="accordion-toggle" href="insert_leito.php"><img src="../ico/leito.png" width="27"height="27" alt="Cadstrar Leito">Cadastrar Leito</a>
					...
					<div class="main_container" id="forms_page">
						...
						<div class="row-fluid">
							<div class="widget widget-padding span12">
							    ...
							    <form class="form-horizontal" action="../model/cads_internacao.php" method="post">
                                             ...
                                             <!-- Dados do paciente-->										
											 	<div class="control-group">
													<br/><label class="control-label">Data da Internação:</label>
														<div class="controls">
															<input type="text" class="data" value="" maxlength="10" autocomplete="off"  name="data_internacao" placeholder="Qual a data da internação?">
														</div>
													<br/><br/><label class="control-label">Diagnóstico:</label>
														<div class="controls">
															<input class="span7"  value="" autocomplete="off" type="text" name="diagnostico_paciente" placeholder="Diagnóstico do paciente" />
															<span class="help-inline">Diagnóstico observado sobre o paciente.</span>
														</div>
													<br/><label class="control-label">Tratamento:</label>
														<div class="controls">
															<input class="span7" value="" autocomplete="off"  name="tratamento_paciente" type="text" placeholder="Tratamento realizado ao paciente"/>
															<span class="help-inline">Tratamento para o paciente.</span>
														</div>
													<br/><label class="control-label">Procedimento:</label>
														<div class="controls">
															<input class="span7"  value="" autocomplete="off" type="text" name="procedimento_paciente" placeholder="Procedimento a realizar ou a prover ao paciente" />
															<span class="help-inline">Procedimento cabivél ao paciente.</span>
														</div>
													<br/><label class="control-label">Médico responsável:</label>
														<div class="controls">
															<input class="span7"  autocomplete="" value=""  type="text" name="crm_medico" placeholder="CRM do médico responsavel pela internação" />
															<span class="help-inline">CRM do médico responsavel pela internação.</span>
														</div>
													<br/><label class="control-label">Hospital da internação:</label>
														<div class="controls">
															<input class="span7"  value="" type="text" name="nome_hospital"  placeholder="Hospital da internação" />
												...
												<div class="control-group">	
													<label class="control-label">Local da internação:</label>
														<div class="controls">
															<input class="span7"  autocomplete="off" value="" type="text" name="local_paciente" placeholder="Local da internação" />
															<span class="help-inline">Qual local estará disposto o paciente.</span>
														</div>
												</div>		
													<br/><label class="control-label">Observações Complementares:</label>
														<div class="controls">
															<textarea class="span7" value="" autocomplete="off" name="observacoes" rows="5" style="height: 100px;"></textarea>
														</div>	
										</div>
									</div>		
