			...
			<div class="main_container" id="forms_page">
						<div class="row-fluid">
							<ul class="breadcrumb">
								...
								<li><a href="javascript:void();">Paciente</a> <span class="divider">/</span></li>
						...
						<div class="row-fluid">
							<div class="widget widget-padding span12">
								<div class="widget-header">
									<i>+</i>
									<h5>Lista com histórico Pacientes</h5>
		...
		<table class='table table-bordered'border='1'>
				<thead>
					<tr class='success'>
						...
						<th colspan='1'><small><center><p class='text-info'>Opções</p></center></small></th>
					</tr>
				</thead>	
					...
					ini_set(“display_errors”, 0 );
						 ...
						 $pega_dados = mysql_query("SELECT * FROM historico");
						 ...
						 while($mostra_dados = mysql_fetch_array($pega_dados)){
							 ...
							 $nome_hospital = $mostra_dados['nome_hospital'];
									...
									echo"<tr class='warning'>";
											...
											echo"<th><center><a href='#'><input class='btn btn-revenge' type='button' value='Regressar Paciente'></a></center></th>";
									echo"</tr>";
