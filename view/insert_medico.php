			...
			<div class="main_container" id="forms_page">
						...
						<div class="row-fluid">
							<div class="widget widget-padding span12">
								...
								<form class="form-horizontal" name="forms"action="../model/cads_medico.php" method="post">
									<div class="widget-body">
										<div class="widget-forms clearfix">					
											<div class="control-group">
												<label class="control-label">Nome:</label>
												<div class="controls">
													<input class="span7" autocomplete="off" required value="" autofocus="true" type="text" name="nome_medico" placeholder="Nome do Médico" />
													<span class="help-inline">Digite o nome completo do médico(a).</span>
												</div>
												<br /> <label class="control-label">CPF:</label>
												<div class="controls">
													<input class="span7" value=""autocomplete="off"  maxlength="14" required name="cpf_medico" onkeypress="javascript: mascara(this, cpf_mask);"type="text" placeholder="CPF do Médico"/>
													<span class="help-inline">Digite apenas os números.</span> 
												</div>
												<br /> <label class="control-label">RG:</label>
												<div class="controls">
													<input class="span7" value="" autocomplete="off"  required name="rg_medico" id="rg" onkeypress="mascara(this, mrg);" size="14" maxlength="12"type="text" placeholder="RG do Médico"/>
													 <span class="help-inline">Digite apenas os números.</span>
												</div>
												<br /> <label class="control-label">Data de Nascimento:</label>
												<div class="controls">
													<input type="text" class='data' maxlength="10"autocomplete="off"  value="" required name="dataNasc_medico" placeholder="Qual a data de nascimento ?">
												</div>
												<br/>
												<div class="positionCRM">
												 <label class="control-label">CRM:</label>
												 	<div class="controls">
													<input  class="span3" value="" autocomplete="off" type="text" required name="crm_medico" placeholder="Digite aqui o CRM">
												</div>
												</div>
												<br /> <label class="control-label">Especialidade:</label>
												<div class="controls">
													<input  class="span7" value="" autocomplete="off" type="text" required name="especialidade_medico" placeholder="Digite aqui a Especialidade do Médico">
												</div>
												<div class="control-group">
												...
												<div class="controls">
													<input class="span7" value="" autocomplete="off" name="endereco_medico" required type="text" name="endereco_medico" placeholder="Endereço do Médico"/>
												</div>
												<br /> <label class="control-label">Bairro:</label>
												<div class="controls">
													<input class="span7" value="" autocomplete="off" required name="bairro_medico" type="text" placeholder="Bairro onde reside o Médico"/>
													<span class="help-inline">Bairro onde reside o médico(a).</span>
												</div>
												<br /> <label class="control-label">Nacionalidade:</label>
												<div class="controls">
													<input class="span7" value="" autocomplete="off" required name="nacionalidade_medico" type="text" placeholder="Nacionalidade do Médico"/>
												</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<select tabindex="1" size="1" name="estado_medico"id="estado" value="" class="span7" data-placeholder="Selecione.." ></select>
													<span class="help-inline">Estado onde reside o médico.</span>
												</div>
											</div>
											<label class="control-label">Cidade:</label>
												<div class="controls">
													<select class="span7" value="" id="cidade"required name="cidade_medico" type="text" data-placeholder="Selecione.."/></select>
												...
												<label class="control-label">Telefone:</label>
														...
														<span class="add-on"><img src="../imagens/icone-telefone.png"style="6px center no-repeat;"></span>
															<input class="span18" autocomplete="off"  onkeyup="mascara( this, mtel );" maxlength="16" value="" required name="telefone_medico" type="tel" placeholder="DDD mais o número somente"/>
															<span class="help-inline">Digite somente os numeros com o código</span>
														</div>	
											</div>
												<span class="help-inline"><span style=" top:826px;position:absolute;left:459px;">Digite somente os números iniciado pelo codigo.</span></span>
											<br/><br/>
											<div>	
											<div class="input-prepend">
												<label class="control-label">Email:</label>
														...
														<span class="add-on">@</span>
															<input class="span18" autocomplete="off"  value=""  name="email_medico" type="email" placeholder="email@exemplo.com">
														</div>
											</div>
											</div>
