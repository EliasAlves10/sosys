			...
			<div class="main_container" id="forms_page">
						<div class="row-fluid">
							<ul class="breadcrumb">
								...
								<li class="active">Solicitar Alta</li>
							</ul>
							<h2 class="heading">
								Solicitando Alta de Paciente
						...
						<div class="row-fluid">
							<div class="widget widget-padding span12">
								...
								<form class="form-horizontal" name="forms"action="../model/cads_alta.php" method="post">
									<div class="widget-body">
										<div class="widget-forms clearfix">					
											<div class="control-group">
													...
													<label class="control-label">Causa para Alta:</label>
														<div class="controls">
															...
															<option>Alta a pedido</option>
															<option>Apto a obtenção da alta médica</option>
															<option>Paciente evadiu-se do leito</option>
															</select>
														</div>
												</div>
												 <br/><label class="control-label">Data da Solicitação:</label>
												<div class="controls">
													<input type="text" class="data" value="" maxlength="10" autocomplete="off"  required name="data_transacao" placeholder="Qual a data da alta médica?">
												...
												<br/><label class="control-label">Hora da alta médica:</label>
												<div class="controls">
													<input type="time" class="span7" value="" maxlength="10" autocomplete="off"  required name="hora_transacao" placeholder="Qual a hora da alta médica?">
													<span class="help-inline">É importante registrar essa informação.</span>
												</div>
												<br/><label class="control-label">Tipo de Admissão:</label>
												<div class="controls">
													<input type="text" class="span7" value="Alta médica" disabled maxlength="10" autocomplete="off"  required name="tipo_admissao" placeholder="Qual a hora da transferência?">
												</div>
												<br/><label class="control-label">Médico Requisitante:</label>
												<div class="controls">
													<input type="text" class="span7" value=""  maxlength="30" autocomplete="off"  required name="crm_medico_requisitante" placeholder="CRM do médico">
