			...
			<div class="main_container" id="forms_page">
						<div class="row-fluid">
							<ul class="breadcrumb">
								...
								<li class="active">Listar Leitos</li>
							</ul>
							<h2 class="heading">
								Lista de Hospitais
						...
						<div class="row-fluid">
							<div class="widget widget-padding span12">
								<div class="widget-header">
									<i>+</i>
									<h5>Lista de Leitos</h5>
									<div class="widget-buttons">
										<a href="#" data-title="Collapse" data-collapsed="false"
										class="tip collapse"><img src="../imagens/sort_both.png"/>
									</div>
								</div>
												...
												<table class="table table-bordered" border="1">
													<thead>
														<tr class='success'>
															...
															<th><small><center><p class='text-info'>Hospital</p></center></small></th>
															<th><small><center><p class='text-info'>Nome do Leito</p></center></small></th>
...
ini_set(“display_errors”, 0 );
     ...
     $pega_dados = mysql_query("SELECT * FROM hospital INNER JOIN leito ON leito.nome_hospital = hospital.nome_hospital");
    
     
     while($mostra_dados = mysql_fetch_array($pega_dados)){
		 $id = $mostra_dados['id'];
         $nome_hospital = $mostra_dados['nome_hospital'];
         $nome_leito  = $mostra_dados['nome_leito'];

        
				echo"<tr class='warning'>";
						echo"<th><small><center>$id</center></small></th>";
						echo"<th><small><center>$nome_hospital</center></small></th>";
						echo"<th><small><center>$nome_leito</center></small></th>";
						echo"<th><center><a href='editer_leito.php?id=$id'><input class='btn btn-primary' type='button' value='Alterar'></a></center></th>";
						echo"<th><center><a href='../model/exc_leito.php?id=$id'><input class='btn btn-danger' type='button' value='Remover'></a></center></th>";
...
?>
				...
				<footer>
					<div id="footerLogo" >
						 <section>
								<p>Copyright  Â© 2014 - SOSsys. - Todos os direitos reservados</p>
						 </section>
					</div>
				</footer>
	</div><!--/.fluid-container-->
