			...
			<div class="main_container" id="forms_page">
						<div class="row-fluid">
							<ul class="breadcrumb">
								...
								<li class="active">Listar Hospitais</li>
							</ul>
							<h2 class="heading">
								Lista de Hospitais
		...
		<table class='table table-bordered'border='1'>
				<thead>
					<tr class='success'>
						...
						<th><small><center><p class='text-info'>Endereço</p></center></small></th>
     ...
     while($mostra_dados = mysql_fetch_array($pega_dados)){
		 ...
		 $email_hospital = $mostra_dados['email_hospital'];
				...
				echo"<tr class='warning'>";
						...
						echo"<th><center><a href='editer_hospital.php?id=$id'><input class='btn btn-primary' type='button' value='Alterar'></a></center></th>";
						echo"<th><center><a href='../model/exc_hospital.php?id=$id'><input class='btn btn-danger' type='button' value='Remover'></a></center></th>";
				echo"</tr>";
		}
?>
