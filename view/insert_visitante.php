										...
										<div class="accordion" id="accordion2">
											...
											<div id="collapse1" class="accordion-body collapse">
												  <div class="accordion-inner">
													<a class="accordion-toggle" href="internacao.php"><img src="../ico/users_into.png" width="30"height="30" alt="InternaÃ§Ã£o">Internação</a>
											  ...
											  <div class="accordion-group">
											   ...
											   <div class="accordion-group">
												...
												<div id="collapse5" class="accordion-body collapse">
												  <div class="accordion-inner">
													<a class="accordion-toggle" href="insert_visitante.php"><img src="../ico/livfro20de20visitas2013.png" width="29"height="29" alt="Alterar">Registrar Visitantes</a>
												  </div>
												</div>
											 </div>
											 <div class="accordion-group">
			...
			<div class="main_container" id="forms_page">
						<div class="row-fluid">
							<ul class="breadcrumb">
								...
								<li><a href="javascript:void();">Visitantes</a> <span class="divider">/</span></li>
								<li class="active">Registrar Visitante</li>
							</ul>
							<h2 class="heading">
								Cadastro de Visitante
								<div class="btn-group pull-right">
									<a href="insert_visitante.php">
										<button class="btn">
											Cadastrar Visitante
										</button>
									</a>	
									...
									<div class="widget-body">
										<div class="widget-forms clearfix">					
											<div class="control-group">
												...
												<div class="controls">
													<input class="span7"autofocus="true" autocomplete="off" required value="" type="text" name="" placeholder="Nome do Visitante" autocomplete="off"/>
												</div>
												<br/><label class="control-label">Paciente a visitar:</label>
												<div class="controls">
													<input class="span7" required value="" autocomplete="off" name=""  type="text"   onpaste="return false;" autocomplete="off"placeholder="Nome do paciente"/>
													<span class="help-inline">Digite o login aqui,para confirmar.</span>
												</div>
												<br /> <label class="control-label">CPF:</label>
												<div class="controls">
													<input class="span7" value="" autocomplete="off" maxlength="14" required name="cpf_usuario" onkeypress="javascript: mascara(this, cpf_mask);"type="text" placeholder="CPF do visitante"autocomplete="off"/>
