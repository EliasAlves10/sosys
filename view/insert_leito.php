			...
			<div class="main_container" id="forms_page">
						<div class="row-fluid">
							<ul class="breadcrumb">
								...
								<li class="active">Cadastrar Leito</li>
							</ul>
							<h2 class="heading">
								Cadastro de Leitos no Hospital
						...
						<div class="row-fluid">
							<div class="widget widget-padding span12">
								...
								<form class="form-horizontal" name="forms"action="../model/cads_leito.php" method="post">
										...
										<div class="widget-forms clearfix">					
											<div class="control-group">
												...
												<div class="controls">
													...
													<span class="help-inline">Hospital onde será cadastrado o leito.</span>
												</div>
												<br /> <label class="control-label">Nome do Leito :</label>
												<div class="controls">
													<input class="span7" value=""  autocomplete="off" required name="nome_leito" onkeypress=""type="text" placeholder="Nome do leito"/>
												</div>
