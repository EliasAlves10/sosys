			...
			<div class="main_container" id="forms_page">
						...
						<div class="row-fluid">
							<div class="widget widget-padding span12">
								...
								<form class="form-horizontal" name="forms"action="../model/cads_hospital.php" method="post">
									<div class="widget-body">
										<div class="widget-forms clearfix">					
											<div class="control-group">
												<label class="control-label">Nome:</label>
												<div class="controls">
													<input class="span7" autofocus="true" autocomplete="off" required value="" type="text" name="nome_hospital" placeholder="Nome do Hospital" />
												</div>
												<br /> <label class="control-label">CNPJ:</label>
												<div class="controls">
													<input class="span7" value="" maxlength="14" autocomplete="off" required name="cnpj_hospital" onkeypress=""type="text" placeholder="CNPJ do Hospital"/>
												</div>
												 <br /><label class="control-label">EndereÃ§o</label>
												<div class="controls">
													<input class="span7" value="" autocomplete="off" name="endereco_hospital" required type="text" name="endereco_paciente" placeholder="EndereÃ§o do Hospital"/>
												</div>
												<br /> <label class="control-label">Bairro:</label>
												<div class="controls">
													<input class="span7" value="" autocomplete="off" required name="bairro_hospital" type="text" placeholder="Bairro do Hospital"/>
												</div>
												
											</div>
											 <label class="control-label">Estado:</label>
												<div class="controls">
													<select class="span7" autocomplete="off" id="estado" value=""  name="estado_hospital" type="text" placeholder=""/></select>
												</div>	
											<br/>
											 <label class="control-label">Cidade:</label>
												<div class="controls">
													<select class="span7" autocomplete="off" id="cidade"value="" name="cidade_hospital" type="text" placeholder="Cidade do Hospital"/></select>
												</div>
											...
											<div class="input-prepend">
												<label class="control-label">Telefone:</label>
														...
														<span class="add-on"><img src="../imagens/icone-telefone.png"style="6px center no-repeat;"></span>
															<input class="span18" autocomplete="off" onkeyup="mascara( this, mtel );" maxlength="16" value="" required name="telefone_hospital" type="tel" placeholder=""/>
														</div>	
											</div>
											<span class="help-inline"><span style=" top:500px;position:absolute;left:459px;">Digite somente os numeros com o cÃ³digo sem o zero.</span></span>
											<br/><br/>
												<div class="input-prepend">
												<label class="control-label">Telefone 2:</label>
														<div class="controls">
														<span class="add-on"><img src="../imagens/icone-telefone.png"style="6px center no-repeat;"></span>
															<input class="span18" autocomplete="off" onkeyup="mascara( this, mtel );" maxlength="16" value=""  name="telefone2_hospital" type="tel" placeholder=""/>
														</div>	
											</div>
											<span class="help-inline"><span style=" top:546px;position:absolute;left:459px;">Digite somente os numeros com o cÃ³digo sem o zero</span></span>											
											<br/><br/>
											<div class="input-prepend">
												<label class="control-label">Email:</label>
														<div class="controls">
														<span class="add-on">@</span>
															<input class="span18" autocomplete="off"  value=""  name="email_hospital" type="email_hospital"  placeholder="email@exemplo.com">/>
														</div>
											</div>
												<span class="help-inline"><span style=" top:596px;position:absolute;left:459px;">Digite aqui o email</span></span>
											<br/><br/>
											<div class="input-prepend">
												<label class="control-label">Total de UTIs:</label>
														<div class="controls">
														<span class="add-on">nÂ°</span>
															<input class="span18" autocomplete="off"  value="" required name="total_uti" type="text" placeholder=""/>
														</div>
											</div>
											<span class="help-inline"><span style=" top:646px;position:absolute;left:459px;">Digite aqui o nÃºmero de UTIs.</span></span>
											<br/><br/>
											<div class="input-prepend">
												<label class="control-label">NÃºmero total de leitos :</label>
														<div class="controls">
														<span class="add-on">nÂ°</span>
															<input class="span18"  autocomplete="off" value="" required name="total_leitos" type="text" placeholder=""/>
														</div>
											</div>
											<span class="help-inline"><span style=" top:696px;position:absolute;left:459px;">Digite aqui o nÃºmero de leitos total do hospital.</span></span>
											<br/><br/>		
