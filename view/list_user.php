		...
		<table class='table table-bordered'border='1'>
				<thead>
					<tr class='success'>
						...
						<th><small><center><p class='text-info'>Login</p></center></small></th>
						<th><small><center><p class='text-info'>Nivel de Acesso</p></center></small></th>
...
ini_set(ìdisplay_errorsî, 0 );
     ...
     $pega_dados = mysql_query("SELECT id,login_usuario,nivel,cpf_usuario FROM usuario");
    
     
     while($mostra_dados = mysql_fetch_array($pega_dados)){
		 $id = $mostra_dados['id'];
         $login_usuario = $mostra_dados['login_usuario'];
         $nivel  = $mostra_dados['nivel'];
		 $cpf_usuario = $mostra_dados['cpf_usuario'];

        	
				echo"<tr class='warning'>";
						echo"<th><small><center>$id</center></small></th>";
						echo"<th><small><center>$login_usuario</center></small></th>";
						echo"<th><small><center>$nivel</center></small></th>";
						echo"<th><small><center>$cpf_usuario</center></small></th>";
						echo"<th><center><a href='editer_user.php?id=$id'><input class='btn btn-primary' type='button' value='Alterar'></a></center></th>";
						echo"<th><center><a href='../model/exc_user.php?id=$id'><input class='btn btn-danger' type='button' value='Remover'></a></center></th>";
				echo"</tr>";
		}
?>
