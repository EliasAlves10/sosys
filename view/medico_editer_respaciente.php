	...
	<div id="wrap">
		...
		<div class="container-fluid">
           ...
           require"../controller/connect_bd.php";
            $id = $_GET["id"];
            $consulta = mysql_query ("SELECT * FROM respaciente WHERE id = $id;");
            ...
            if($consulta == false) {
               ...
               while($camp =@mysql_fetch_array($consulta)){
			     $id = $camp["id"];
                 $nomeResp_paciente = $camp["nomeResp_paciente"];
				 $enderecoResp_paciente = $camp["enderecoResp_paciente"];
				 $bairroResp_paciente = $camp["bairroResp_paciente"];
				 $estadoResp_paciente = $camp["estadoResp_paciente"];
				 $cidadeResp_paciente = $camp["cidadeResp_paciente"];
				 $telefoneResp_paciente = $camp["telefoneResp_paciente"];
				 $telefoneResp_paciente2 = $camp["telefoneResp_paciente2"];
			...
			<div class="main_container" id="forms_page">
						...
						<div class="row-fluid">
							<div class="widget widget-padding span12">
								...
								<form class="form-horizontal" action="../model/medico_update_respaciente.php" method="post">
									<div class="widget-body">
										<div class="widget-forms clearfix">
                                             <div class="control-group">
													<div class="controls">
															<input class="span7" autocomplete="off"  value="<?php echo $id;?>"autofocus="true" type="hidden" name="id" placeholder="" />
														</div><br/>
													<label class="control-label">Nome:</label>
														<div class="controls">
															<input class="span7"autofocus="true" autocomplete="off"  value="<?php echo $nomeResp_paciente;?>"autofocus="true" type="text" name="nomeResp_paciente" placeholder="Nome completo do responsavel pelo paciente" />
														</div>
													<br/><label class="control-label">Endereço:</label>
														<div class="controls">
															<input class="span7" autocomplete="off" value="<?php echo $enderecoResp_paciente;?>" type="text" name="enderecoResp_paciente" placeholder="Endereço do responsavel pelo paciente" />
														</div>
													<br /> <label class="control-label">Bairro:</label>
														<div class="controls">
															<input class="span7" autocomplete="off" value="<?php echo $bairroResp_paciente;?>"  name="bairroResp_paciente" type="text" placeholder="Bairro do responsavel pelo paciente"/>
														</div>
														<br/><div class="control-group">
												<label class="control-label">Estado:</label>
												<div class="controls">
													<input id="estado" name="estadoResp_paciente" type="text"value="<?php echo $estadoResp_paciente;?>" class="span7" data-placeholder="Selecione.." >
														<span class="help-inline">Estado onde reside o responsavel pelo paciente.</span>
												</div>
											</div>
												<label class="control-label">Cidade:</label>
														<div class="controls">
															<input class="span7" id="cidade" value="<?php echo $cidadeResp_paciente;?>"  name="cidadeResp_paciente" type="text" placeholder="Cidade atual do responsavel pelo paciente "/>
												...
												<label class="control-label">Telefone:</label>
														...
														<span class="add-on"><img src="../imagens/icone-telefone.png"style="6px center no-repeat;"></span>
															<input class="span18" autocomplete="off" onkeyup="mascara( this, mtel );" maxlength="16" value="<?php echo $telefoneResp_paciente;?>"  name="telefoneResp_paciente" type="tel" placeholder=""/>
												...
												<label class="control-label">Telefone 2:</label>
														<div class="controls">
														<span class="add-on"><img src="../imagens/icone-telefone.png"style="6px center no-repeat;"></span>
															<input class="span18" autocomplete="off" onkeyup="mascara( this, mtel );" maxlength="16" value="<?php echo $telefoneResp_paciente2;?>"  name="telefoneResp_paciente2" type="tel" placeholder=""/>
															<span class="help-inline">Digite somente os numeros com o código</span>
														</div>				
													</div>	
