		...
		<table class='table table-bordered'border='1'>
				<thead>
					<tr class='success'>
						...
						<th colspan='1'><small><center><p class='text-info'>Leitos Cadastrados</p></center></small></th>
					</tr>
				</thead>	
...
ini_set(“display_errors”, 0 );
     ...
     $pega_dados = mysql_query("SELECT id,nome_hospital,endereco_hospital,bairro_hospital,telefone_hospital,email_hospital FROM hospital");
     ...
     while($mostra_dados = mysql_fetch_array($pega_dados)){
		 ...
		 $email_hospital = $mostra_dados['email_hospital'];
				...
				echo"<tr class='warning'>";
						...
						echo"<th><center><a href='vizualiza_leito.php?id=$id'><input class='btn btn-revenge' type='button' value='Vizualizar Leitos'></a></center></th>";
