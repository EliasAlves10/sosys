								...
								<div class="widget-header">
									...
									<div class="widget-body">
										<div class="widget-forms clearfix">					
											<!--Começa aki a formção da tabela-->
		...
		<table class='table table-bordered'border='1'>
				<thead>
					<tr class='success'>
						...
						<th><small><center><p class='text-info'>Diagnóstico</p></center></small></th>
						<th><small><center><p class='text-info'>Tratamento</p></center></small></th>
						<th><small><center><p class='text-info'>Hóspital da internação</p></center></small></th>
						<th colspan='2'><small><center><p class='text-info'>Opções</p></center></small></th>
					</tr>
				</thead>	
			...
			ini_set(“display_errors”, 0 );
				 ...
				 $pega_dados = mysql_query("SELECT *"
						 ."FROM paciente INNER JOIN internacao ON internacao.id = paciente.id");
				
				 
				 while($mostra_dados = mysql_fetch_array($pega_dados)){
					 $id = $mostra_dados['id'];
					 $nome_paciente = $mostra_dados['nome_paciente'];
					 $diagnostico_paciente = $mostra_dados['diagnostico_paciente'];
					 $tratamento_paciente = $mostra_dados['tratamento_paciente'];
					 $nome_hospital = $mostra_dados['nome_hospital'];
							...
							echo"<tr class='warning'>";
									...
									echo"<th><small><center>$diagnostico_paciente</center></small></th>";
									echo"<th><small><center>$tratamento_paciente</center></small></th>";
									echo"<th><small><center>$nome_hospital</center></small></th>";
									echo"<th><center><a href='alta_paciente.php?id=$id'><input class='btn btn-inverse' type='button' value='Solicitar Alta'></a></center></th>";
									echo"<th><center><a href='transfere_paciente.php?id=$id'><input class='btn btn-warning' type='button' value='Transferência'></a></center></th>";
							echo"</tr>";
