		...
		<div class="container-fluid">
										...
										<div class="accordion" id="accordion2">
											...
											<div id="collapse1" class="accordion-body collapse">
												  <div class="accordion-inner">
													<a class="accordion-toggle" href="internacao.php"><img src="../ico/users_into.png" width="30"height="30" alt="InternaÁ„o">Interna√ß√£o</a>
											...
											<div class="accordion-group">
												...
												<div id="collapse2" class="accordion-body collapse">
												  <div class="accordion-inner">
													...
													<a class="accordion-toggle" href="#"><img src="../ico/alterhosp.png" width="29"height="29" alt="Alterar">Listar H√≥spitais</a>
											 ...
											 <div class="accordion-group">
												<div class="accordion-heading">
													<a class="accordion-toggle b_F5C294" href="#"><img src="../ico/info.png" width="26"height="26" alt="Painel de Vagas"><span>Sobre</span></a>
												</div>
											  </div>      
										</div>
           ...
           require"../controller/connect_bd.php";
            ...
            if($consulta == false) {
               ...
               $id= $camp["id"];
               $login_usuario = $camp["login_usuario"];
               $senha_usuario = $camp["senha_usuario"];
			   $cpf_usuario = $camp["cpf_usuario"];
			    $nivel = $camp["nivel"];
               }
            }
			...
			<div class="main_container" id="forms_page">
						...
						<div class="row-fluid">
							<div class="widget widget-padding span12">
								...
								<form class="form-horizontal" name="forms"action="../model/update_user.php" method="post">
									<div class="widget-body">
										<div class="widget-forms clearfix">					
											<div class="control-group">
												...
												<div class="controls">
													<input class="span7"autofocus="true" required value="<?php echo $login_usuario;?>" type="text" name="login_usuario" placeholder="Login do Usuario" autocomplete="off"/>
												</div>
												<br/><label class="control-label">Confirma√ß√£o de Login:</label>
												<div class="controls">
													<input class="span7" required value="<?php echo $login_usuario;?>" name="confirm_login_usuario" oninput="validasenha(this);" onsubmit="validasenha(this);" type="text"   onpaste="return false;" autocomplete="off"placeholder="Confirma√ß√£o de login do Usuario" />
													<span class="help-inline">Digite aqui o login novamente para confirma√ß√£o.</span>
												</div>
												<br /> <label class="control-label">CPF:</label>
												<div class="controls">
													<input class="span7" value="<?php echo $cpf_usuario;?>" maxlength="14" required name="cpf_usuario" onkeypress="javascript: mascara(this, cpf_mask);"type="text" placeholder="CPF do Usuario"autocomplete="off"/>
													<span class="help-inline">Digite Apenas os n√∫meros.</span>
												</div>
												<br /> <label class="control-label">Senha:</label>
												<div class="controls">
													<input class="span7" value="<?php echo $senha_usuario;?>" maxlength="14" required name="senha_usuario" type="text" placeholder="Senha do Usuario"autocomplete="off"/>
												</div>
											</div>
											<div class="control-group">
